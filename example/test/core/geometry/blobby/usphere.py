...
def print_blobby_usphere( P_uspehre ):
    #print_string( "Interval: " )
    #print_interval( P_uspehre.interval() )
    print_string( str( usphere1.radius() ) )
...
usphere1 = IceRayCpp.GeometryBlobbyUSphere()

usphere1.radius( 0.666 )

print_blobby_usphere( usphere1 )