...
def identical( scale = IceRayCpp.MathTypeCoord3D().load( 1, 2, 0.5 ) ): # 1, 1, 0.2
    ...
    projective = IceRayCpp.GeometryTransformProjective( child )

    return { 'this': projective, '1': child }
...
def uniform( scale = 0.61803398874989484820458683436564 ):
    ...
    #projective.scale( IceRayCpp.MathTypeCoord3D().fill(0), scale )
    #projective.rotate( IceRayCpp.MathTypeCoord3D().fill(0), IceRayCpp.MathTypeCoord3D().load(1,0,0), -0.7 )
    #projective.rotate( IceRayCpp.MathTypeCoord3D().fill(0), IceRayCpp.MathTypeCoord3D().load(0,0,1), -0.7 )
    #projective.rotate( IceRayCpp.MathTypeCoord3D().fill(0), IceRayCpp.MathTypeCoord3D().load(0,0,1), -0.7 )
