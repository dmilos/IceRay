...
def make_geometry_rtss_list( ): # P_center, P_radius
    ...
    return { 'this': geometry, '-1': list,  '1' : sample_cargo, '2': box, '3': translate }
...
def make_surface( ):
    ...
    #MaterialIlluminationLambert( [color]result, [coord]point, [coord]normal, [size]lightCount, [color]diffuse )
