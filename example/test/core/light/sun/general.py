...
def area( P_height = 1 + (math.sqrt(5)-1)/2, P_sample = 100 ):

    sun = IceRayCpp.LightSunGeneral()
...
def circle( P_height = 1 + (math.sqrt(5)-1)/2, P_sample = 100 ):
...
def disc( P_height = 1 + (math.sqrt(5)-1)/2, P_sample = 100 ):
...
def line( P_height =  1 + (math.sqrt(5)-1)/2, P_sample = 100 ):
    sun = IceRayCpp.LightSunGeneral()
...
def point( P_height = 1 + (math.sqrt(5)-1)/2 ):
