...
def make( P_light, P_image = str( os.getcwd()[0] ) + ":\\work\\code\\cpp\\prj\\github\\IceRay\\work\\data\\di.pnm" ):
    ...
    surface_cargo['1'] = IceRayCpp.MaterialCoord3DMappingCartesian2Spherical( 0, 2 )
    surface_cargo['2'] = IceRayCpp.MaterialPatternFunctionColor( surface_cargo['image']['function'], 2, 1 )
