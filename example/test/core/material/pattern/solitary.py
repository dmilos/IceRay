...
def make_object(  ):
    ...
    cargo_geometry={}
    cargo_geometry['this'] = IceRayCpp.GeometrySimpleBox( IceRayCpp.MathTypeCoord3D().fill(-1), IceRayCpp.MathTypeCoord3D().fill(1) )
    object.geometry( cargo_geometry['this'] )

    cargo_surface = unit.hexagon( )
...
def make_camera( ): # P_eye, P_view, P_up
    ...
    eye  = IceRayCpp.MathTypeCoord3D();  eye.load( 1.5, 1.5, -2.5 )
