...
def perlin( P_light ):
    ...
    surface_cargo['1'] = IceRayCpp.MaterialPatternScalarFunction( surface_cargo['perlin']['function'], 0, 0 )
    surface_cargo['2'] = IceRayCpp.MaterialConvertScalar2Color( 0, 1 )
    surface_cargo['3'] = IceRayCpp.MaterialIlluminationAmbient( 0, 1 )
...
def cells( P_light ):
    ...
    surface_cargo['1'] = IceRayCpp.MaterialPatternScalarFunction( surface_cargo['cells']['function'], 0, 0 )
    surface_cargo['2'] = IceRayCpp.MaterialConvertScalar2Color( 0, 1 )
    surface_cargo['3'] = IceRayCpp.MaterialIlluminationAmbient( 0, 1 )
...
def random( P_light ):
    ...
    surface_cargo['1'] = IceRayCpp.MaterialPatternScalarFunction( surface_cargo['random']['function'], 0, 0 )
    surface_cargo['2'] = IceRayCpp.MaterialConvertScalar2Color( 0, 1 )
    surface_cargo['3'] = IceRayCpp.MaterialIlluminationAmbient( 0, 1 )
...
def gold( P_light ):
    ...
    surface_cargo['1'] = IceRayCpp.MaterialPatternScalarFunction( surface_cargo['gold']['function'], 0, 0 )
    surface_cargo['2'] = IceRayCpp.MaterialConvertScalar2Color( 0, 1 )
    surface_cargo['3'] = IceRayCpp.MaterialIlluminationAmbient( 0, 1 )
...
def vdc( P_light ):
    ...
    surface_cargo['1'] = IceRayCpp.MaterialPatternScalarFunction( surface_cargo['vdc']['function'], 0, 0 )
    surface_cargo['2'] = IceRayCpp.MaterialConvertScalar2Color( 0, 1 )
    surface_cargo['3'] = IceRayCpp.MaterialIlluminationAmbient( 0, 1 )
