...
def make( 
    ...
    P_shines   = IceRayCpp.GraphTypeColorRGB().fill( 10 )
):
    ...
    cargo['6'] = IceRayCpp.MaterialPatternColorConstant( P_shines.fill( 10 ), 2 )
    #MaterialIlluminationBlinn( [coord]point, [coord]normal, [size]lightCount, [color]specular, [color]shines, [color]result  )
    cargo['7'] = IceRayCpp.MaterialIlluminationBlinn( 0, 1, 0, 1, 2, 0 )
