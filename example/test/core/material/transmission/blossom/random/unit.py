...
def make(
    ...
    #MaterialTransmissionBlossom( [coord]normal, [scalar]leader, [size]count, [scalar]angle, [scalar]gauss )
    cargo['8'] = IceRayCpp.MaterialTransmissionBlossomRandom( 1, 1, 2, 2, 3 )
