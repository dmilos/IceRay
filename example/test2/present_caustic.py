...
for object in [ 'Q-sphere' ]:  # 'V-Vacuum'
    ...
    for blossom in [ 'sunflower', 'vdc', 'congruent', 'random', 'triangle', 'grid', 'hexagon', 'LD'  ]: # 
...
for blossom in [ 'LD', 'vdc', 'congruent', 'sobol', 'random',  'sunflower', 'triangle', 'grid', 'hexagon', 'grid'  ]: #   
