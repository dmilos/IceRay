...
GC__base::T2_perspective GC__base::M2s_camera;
//GC__base::T1_base        GC__base::M2s_base;

GC__base::GC__base( void )
...
void GC__base::Fv_camera( T_camera* P_camera )
 {
  M2_camera = ( nullptr == P_camera ? &M2s_camera : P_camera );
 }

void GC__base::F1v_render( T_color & P_color, T_coord const& P_coord )
 {
