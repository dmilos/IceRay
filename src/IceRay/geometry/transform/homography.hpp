         ...
         class GC_homography
          ...
          , public GS_DDMRM::S_IceRay::S_geometry::S__pure::GC_transform
          {
           public:
             ...
             typedef GS_DDMRM::S_IceRay::S_type::S_matrix::GT_scalar4D  T_homography;
             ...
             GC_homography( );
             GC_homography( T__base * P_child );
             GC_homography( T__base * P_child, T_homography const& P_2world );
           //GC_homography( T__base * P_child,  T_matrix const&P_linear, T_coord const& P_center );
            ~GC_homography( );
