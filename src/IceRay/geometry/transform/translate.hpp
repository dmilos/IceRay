#ifndef _DDMM_IceRAY_geometry_transfrom_translate_H_
 #define _DDMM_IceRAY_geometry_transfrom_translate_H_
     ...
     // TODO, public GS_DDMRM::S_IceRay::S_geometry::S__pure::GC_transform
          {
           ...
           public:
             ...
             explicit GC_translate(  T__base *P_child );
             GC_translate( T__base *P_child, T_coord const& P_move );
            ~GC_translate( );
