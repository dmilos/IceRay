#ifndef _DDMM_IceRAY_geometry_transfrom_projective_H_
 #define _DDMM_IceRAY_geometry_transfrom_projective_H_
         ...
         class GC_projective
          ...
          , public GS_DDMRM::S_IceRay::S_geometry::S__pure::GC_transform
          {
           public:
             ...
             typedef GS_DDMRM::S_IceRay::S_type::S_matrix::GT_scalar4D  T_projective;
             ...
             GC_projective( );
             GC_projective( T__base * P_child );
             GC_projective( T__base * P_child, T_projective const& P_2world );
           //GC_projective( T__base * P_child,  T_matrix const&P_linear, T_coord const& P_center );
            ~GC_projective( );
           ...
           public:
             T_projective    const& F_2world()const{ return M2_2world; }
             bool                   F_2world( T_projective const& P_2world );
           private:
             T_projective M2_2world;

           public:
             T_projective    const& F_2local()const{ return M2_2local; }
             bool                   F_2local( T_projective const& P_2local );
           private:
             T_projective M2_2local;
           private:
