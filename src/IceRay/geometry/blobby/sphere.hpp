         ...
         : public GS_DDMRM::S_IceRay::S_geometry::S_blobby::GC__element
          {
           ...
           public:
             GC_sphere(  );
             GC_sphere( T_coord const& P_center );
             GC_sphere( T_coord const& P_center, T_scalar const& P_radius, T_scalar const& P_influence );
            ~GC_sphere( );
           ...
           public:
             T_scalar    const& F_influence()const{ return M2_influence; }
             bool               F_influence( T_scalar const& P_influence ){ M2_influence = P_influence; return bool( true ); }
           private:
             T_scalar M2_influence;

           private:
             T_scalar M2_c0, M2_c1;
