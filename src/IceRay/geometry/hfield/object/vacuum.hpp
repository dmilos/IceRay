#ifndef _DDMM_IceRAY_geometry_hfield_object_vacuum_H_
 #define _DDMM_IceRAY_geometry_hfield_object_vacuum_H_

// GS_DDMRM::S_IceRay::S_geometry::S_hfield::S_object::GC_vacuum
