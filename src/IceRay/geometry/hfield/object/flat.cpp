...
bool GC_flat::Fv_intersect
 ( 
   T_scalar &P_lambda
  ,T_scalar const& P_00, T_scalar const& P_10, T_scalar const& P_01, T_scalar const& P_11
  ,T_ray const& P_ray 
 )const
 {
...
#if defined( _DEBUG )
  T_scalar I_z = I_origin[2] + I_lambda *I_direction[2];
#endif
...
void GC_flat::Fv_height( T_scalar &P_height, T_scalar const& P_00, T_scalar const& P_10, T_scalar const& P_01, T_scalar const& P_11, T_scalar const& P_x, T_scalar const& P_y )const
 {
  T_scalar I_level = ( P_00+ P_01+ P_10+ P_11 ) * 0.25;
  P_height = I_level;
 }

void GC_flat::Fv_normal( T_coord  &P_normal, T_scalar const& P_00, T_scalar const& P_10, T_scalar const& P_01, T_scalar const& P_11, T_scalar const& P_x, T_scalar const& P_y )const
 {
