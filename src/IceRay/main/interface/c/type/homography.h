...
// TODO IceRayC__EXPORT IceRayC__DECLSPEC  int  IceRayC_Type_Math_Homography_Construct1D( IceRayC_Type_Math_Matrix3D *P_result, IceRayC_TypeCoordScalar1D *P_A, IceRayC_TypeCoordScalar1D *P_B );
