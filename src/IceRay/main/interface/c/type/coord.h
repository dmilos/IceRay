...
typedef struct IceRayC_TypeCoordScalar1D{ IceRayC_Type_Scalar value[1]; } IceRayC_TypeCoordScalar1D, IceRayC_Type_Coord_Scalar1D, IceRayC_Type_Math_Coord_Scalar1D;
typedef struct IceRayC_TypeCoordScalar2D{ IceRayC_Type_Scalar value[2]; } IceRayC_TypeCoordScalar2D, IceRayC_Type_Coord_Scalar2D, IceRayC_Type_Math_Coord_Scalar2D;
typedef struct IceRayC_TypeCoordScalar3D{ IceRayC_Type_Scalar value[3]; } IceRayC_TypeCoordScalar3D, IceRayC_Type_Coord_Scalar3D, IceRayC_Type_Math_Coord_Scalar3D; 
typedef struct IceRayC_TypeCoordScalar4D{ IceRayC_Type_Scalar value[4]; } IceRayC_TypeCoordScalar4D, IceRayC_Type_Coord_Scalar4D, IceRayC_Type_Math_Coord_Scalar4D;
