...
IceRayC__EXPORT IceRayC__DECLSPEC  int  IceRayC_Type_Math_Affine4D_ID( IceRayC_Type_Math_Affine4D *P_that );

IceRayC__EXPORT IceRayC__DECLSPEC  int  IceRayC_Type_Math_Affine1D_Zero( IceRayC_Type_Math_Affine1D *P_that );
IceRayC__EXPORT IceRayC__DECLSPEC  int  IceRayC_Type_Math_Affine2D_Zero( IceRayC_Type_Math_Affine2D *P_that );
IceRayC__EXPORT IceRayC__DECLSPEC  int  IceRayC_Type_Math_Affine3D_Zero( IceRayC_Type_Math_Affine3D *P_that );
IceRayC__EXPORT IceRayC__DECLSPEC  int  IceRayC_Type_Math_Affine4D_Zero( IceRayC_Type_Math_Affine4D *P_that );
