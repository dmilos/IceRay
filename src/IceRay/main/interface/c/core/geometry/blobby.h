...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Sphere_Core(   IceRayC_Geometry_Blobby_Element_Handle P_that, IceRayC_TypeScalar P_core );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Sphere_Radius( IceRayC_Geometry_Blobby_Element_Handle P_that, IceRayC_TypeScalar P_radius );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Sphere_Center( IceRayC_Geometry_Blobby_Element_Handle P_that, IceRayC_TypeCoordScalar3D* P_center );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_USphere_Core( IceRayC_Geometry_Blobby_Element_Handle P_that,IceRayC_TypeScalar P_core );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_UCylinderZ_Core( IceRayC_Geometry_Blobby_Element_Handle P_that,IceRayC_TypeScalar P_core );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_UWaterZ_Level( IceRayC_Geometry_Blobby_Element_Handle P_that,IceRayC_TypeScalar P_level );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Translate_Move( IceRayC_Geometry_Blobby_Element_Handle P_that,  IceRayC_TypeCoordScalar3D* P_translate );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Translate_Child( IceRayC_Geometry_Blobby_Element_Handle P_that, IceRayC_Geometry_Blobby_Element_Handle P_child );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Affine_2World_Get( IceRayC_Geometry_Blobby_Element_Handle P_that,  IceRayC_Type_Math_Affine3D P_2world );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Affine_2World_Set( IceRayC_Geometry_Blobby_Element_Handle P_that,  IceRayC_Type_Math_Affine3D P_2world );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Affine_2World_Get( IceRayC_Geometry_Blobby_Element_Handle P_that,  IceRayC_Type_Math_Affine3D P_2world );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Affine_2World_Set( IceRayC_Geometry_Blobby_Element_Handle P_that,  IceRayC_Type_Math_Affine3D P_2world );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool                      IceRayC_Geometry_Blobby_Affine_Child( IceRayC_Geometry_Blobby_Element_Handle P_that, IceRayC_Geometry_Blobby_Element_Handle P_child );
