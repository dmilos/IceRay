...
IceRayC__EXPORT IceRayC__DECLSPEC int    IceRayC_Material_Medium_Release( IceRayC_Material_MediumHandle P_this );
...
IceRayC__EXPORT IceRayC__DECLSPEC IceRayC_Material_MediumHandle  IceRayC_Material_Medium_Constant1( IceRayC_TypeColorRGB const*P_value, IceRayC_TypeColorRGB const*P_deplete);
IceRayC__EXPORT IceRayC__DECLSPEC int                            IceRayC_Material_Medium_Constant_Value(   IceRayC_Material_MediumHandle P_this, IceRayC_TypeColorRGB const* P_value   );
IceRayC__EXPORT IceRayC__DECLSPEC int                            IceRayC_Material_Medium_Constant_Deplete( IceRayC_Material_MediumHandle P_this, IceRayC_TypeColorRGB const* P_deplete );
...
IceRayC__EXPORT IceRayC__DECLSPEC IceRayC_Material_MediumHandle  IceRayC_Material_Medium_Quadratic1( IceRayC_TypeColorRGB const* P_value, IceRayC_TypeScalar P_A, IceRayC_TypeScalar P_B, IceRayC_TypeScalar P_C );
IceRayC__EXPORT IceRayC__DECLSPEC int                            IceRayC_Material_Medium_Quadratic_Value(  IceRayC_Material_MediumHandle P_that, IceRayC_TypeColorRGB const* P_value );
...
IceRayC__EXPORT IceRayC__DECLSPEC IceRayC_Material_MediumHandle  IceRayC_Material_Medium_Exponential1( IceRayC_TypeColorRGB const*P_value, IceRayC_TypeScalar P_half );
IceRayC__EXPORT IceRayC__DECLSPEC int                            IceRayC_Material_Medium_Exponential_Value(   IceRayC_Material_MediumHandle P_this, IceRayC_TypeColorRGB const* P_value   );
