...
void IceRayC_Material_PatternSizeRelease( IceRayC_Material_Pattern_SizeHandle P_this )
 {
  typedef GS_DDMRM::S_IceRay::S_material::S_pattern::GT__size Tf__pure;
...
IceRayC_Material_Pattern_SizeHandle IceRayC_Material_Pattern_Brick0( )
 {
  ...
  return reinterpret_cast<IceRayC_Material_Pattern_SizeHandle>( dynamic_cast< Tf__pure *> ( Ir_result ) );
 }
...
void IceRayC_Material_PatternScalarRelease( IceRayC_Material_Pattern_ScalarHandle P_this )
 {
...
IceRayC_Material_Pattern_ScalarHandle IceRayC_Material_Pattern_Scalar_Level0( )
 {
  ...
  return reinterpret_cast<IceRayC_Material_Pattern_ScalarHandle>( dynamic_cast< Tf__pure *> ( Ir_result ) );
 }
...
void IceRayC_Material_Pattern_ColorRelease( IceRayC_Material_Pattern_ColorHandle P_this )
 {
  typedef GS_DDMRM::S_IceRay::S_material::S_pattern::GT__color Tf__pure;
  auto I_this = reinterpret_cast<Tf__pure*> ( P_this );
  delete I_this;
 }
...
IceRayC_Material_Pattern_ScalarHandle IceRayC_Material_Pattern_Color_Image1( IceRayC_Type_PictureHandle P_picture )
 {
  typedef GS_DDMRM::S_IceRay::S_material::S_pattern::GT__scalar Tf__pure;
  typedef GS_DDMRM::S_IceRay::S_type::S_picture::GC__pure       Tf_picture;

  auto Ir_result = new GS_DDMRM::S_IceRay::S_material::S_pattern::GC_image{ reinterpret_cast< Tf_picture* >( P_picture )};

  return reinterpret_cast<IceRayC_Material_Pattern_ScalarHandle>( dynamic_cast< Tf__pure *> ( Ir_result ) );
 }

int IceRayC_Material_Pattern_Color_Image_Picture( IceRayC_Material_Pattern_ScalarHandle P_this, IceRayC_Type_PictureHandle P_picture )
 {
  typedef GS_DDMRM::S_IceRay::S_material::S_pattern::GT__scalar Tf__pure;
  typedef GS_DDMRM::S_IceRay::S_type::S_picture::GC__pure      Tf_picture;
  ...
  auto I_this = dynamic_cast<Tf_image*>( reinterpret_cast< Tf__pure* >( P_this ) );
...
void IceRayC_Material_PatternCoord2DRelease( IceRayC_Material_Pattern_Coord2DHandle P_this )
 {
  typedef GS_DDMRM::S_IceRay::S_material::S_pattern::GT__coord2D Tf__pure;
  auto I_this = reinterpret_cast<Tf__pure*> ( P_this );
  delete I_this;
 }
...
void IceRayC_Material_PatternCoord3DRelease( IceRayC_Material_Pattern_Coord3DHandle P_this )
 {
  typedef GS_DDMRM::S_IceRay::S_material::S_pattern::GT__coord3D Tf__pure;
  auto I_this = reinterpret_cast<Tf__pure*> ( P_this );
  delete I_this;
 }
// TODO Coord3d
...
void IceRayC_Material_PatternCoord4DRelease( IceRayC_Material_Pattern_Coord4DHandle P_this )
 {
  typedef GS_DDMRM::S_IceRay::S_material::S_pattern::GT__coord4D Tf__pure;
  auto I_this = reinterpret_cast<Tf__pure*> ( P_this );
  delete I_this;
 }
