...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Release( IceRayC_Camera_Handle P_this );

IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Camera_Handle IceRayC_Camera_Flat_Orthogonal0( );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Flat_Orthogonal_Width(  IceRayC_Camera_Handle P_that, IceRayC_TypeScalar P_width );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Flat_Orthogonal_Height( IceRayC_Camera_Handle P_that, IceRayC_TypeScalar P_height );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Flat_Orthogonal_Aspect( IceRayC_Camera_Handle P_that, IceRayC_TypeScalar P_aspect );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Flat_Super_Ocular(     IceRayC_Camera_Handle P_that, IceRayC_Type_Coord_Scalar2D* P_ocular    );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Flat_Super_View(       IceRayC_Camera_Handle P_that, IceRayC_Type_Coord_Scalar2D* P_view      );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Flat_Super_Objective(  IceRayC_Camera_Handle P_that, IceRayC_Type_Coord_Scalar2D* P_objective );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Flat_Super_Focus(      IceRayC_Camera_Handle P_that, IceRayC_Type_Coord_Scalar2D* P_focus     );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Sphere_Fisheye_Horizontal(  IceRayC_Camera_Handle P_that, IceRayC_TypeScalar P_horizont );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Sphere_Fisheye_Vertical(    IceRayC_Camera_Handle P_that, IceRayC_TypeScalar P_vertical );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_DOF_Cone_Child(    IceRayC_Camera_Handle P_that, IceRayC_Camera_Handle P_child );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_DOF_Cone_Sample(   IceRayC_Camera_Handle P_that, IceRayC_TypeSize P_sample );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_DOF_Cone_Aperture( IceRayC_Camera_Handle P_that, IceRayC_TypeScalar P_aperture );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_DOF_Cone_Gauss(    IceRayC_Camera_Handle P_that, IceRayC_TypeScalar P_gauss );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Camera_Handle IceRayC_Camera_DOF_Cylinder0();
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Camera_Handle IceRayC_Camera_DOF_Cylinder1(                                IceRayC_TypeSize P_sample, IceRayC_TypeScalar P_aperture );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Camera_Handle IceRayC_Camera_DOF_Cylinder2( IceRayC_Camera_Handle P_child, IceRayC_TypeSize P_sample, IceRayC_TypeScalar P_aperture );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Camera_Handle IceRayC_Camera_DOF_Cylinder3( IceRayC_Camera_Handle P_child, IceRayC_TypeSize P_sample, IceRayC_TypeScalar P_aperture, IceRayC_TypeScalar P_gauss );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_DOF_Cylinder_Child(    IceRayC_Camera_Handle P_that, IceRayC_Camera_Handle P_child );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_DOF_Cylinder_Sample(   IceRayC_Camera_Handle P_that, IceRayC_TypeSize P_sample );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Transform_Affine_Child(      IceRayC_Camera_Handle P_that, IceRayC_Camera_Handle P_child );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Transform_Affine_2Local_Get( IceRayC_Camera_Handle P_that, IceRayC_Type_Math_Affine3D * P_2world );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Transform_Affine_2Local_Set( IceRayC_Camera_Handle P_that, IceRayC_Type_Math_Affine3D * P_2local );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Transform_Affine_2World_Get( IceRayC_Camera_Handle P_that, IceRayC_Type_Math_Affine3D * P_2world );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Transform_Affine_2World_Set( IceRayC_Camera_Handle P_that, IceRayC_Type_Math_Affine3D * P_2world );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Transform_Invert_Child( IceRayC_Camera_Handle P_that, IceRayC_Camera_Handle P_child );
...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Transform_Pin_Child( IceRayC_Camera_Handle P_that, IceRayC_Camera_Handle P_child );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool     IceRayC_Camera_Transform_Pin_Origin( IceRayC_Camera_Handle P_that, IceRayC_Type_Coord_Scalar3D * P_origin );
