...
{
  IceRayC_Type_Math_Coord_Scalar3D m_coord;
...
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Area_Origin( IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D * P_origin );
...
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Area_X(      IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D*  P_X      );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Area_Y(      IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D*  P_Y      );
...
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Circle_Center( IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_center );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Circle_X( IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_X );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Circle_Y( IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_Y );
...
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Disc_Center( IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_center );
...
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Disc_X(      IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_X      );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Disc_Y(      IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_Y      );
...
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Line_Start(  IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_start );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Line_End(    IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_end );

IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Light_Handle IceRayC_Light_Point0();
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Light_Handle IceRayC_Light_Point1( IceRayC_Type_Math_Coord_Scalar3D* center, IceRayC_TypeColorRGB* c0, IceRayC_TypeColorRGB* c1, IceRayC_TypeColorRGB *c2 );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Point_Spot(   IceRayC_Light_Handle P_this, IceRayC_TypeSpot* P_spot );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Point_Center( IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_center );

IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Light_Handle IceRayC_Light_Reflector0( );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Reflector_Center(    IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_center );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Reflector_Spot(      IceRayC_Light_Handle P_this, IceRayC_TypeSpot* P_spot );
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Reflector_Direction( IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_direction );
...
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_Spline_CP( IceRayC_Light_Handle P_this, IceRayC_TypeSize P_sample, IceRayC_Type_Math_Coord_Scalar3D* P_0 );
...
IceRayC__EXPORT IceRayC__DECLSPEC  int                  IceRayC_Light_SunS_Center( IceRayC_Light_Handle P_this, IceRayC_Type_Math_Coord_Scalar3D* P_center );
