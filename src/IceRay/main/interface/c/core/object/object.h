...
IceRayC__EXPORT IceRayC__DECLSPEC  int                        IceRayC_Object_GeometrySet( IceRayC_Object_Handle P_this, IceRayC_Geometry_Handle  P_gemetry );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Geometry_Handle    IceRayC_Object_GeometryGet( IceRayC_Object_Handle P_this );
