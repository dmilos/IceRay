...
IceRayC__EXPORT IceRayC__DECLSPEC  int                           IceRayC_Render_Scanner_Block_Hot( IceRayC_Render_Scanner_Handle P_this, IceRayC_TypeCoordSize2D* P_hot );

IceRayC__EXPORT IceRayC__DECLSPEC  int                           IceRayC_Render_Scanner_Block_Window( IceRayC_Render_Scanner_Handle P_this, IceRayC_TypeCoordSize2D* P_A, IceRayC_TypeCoordSize2D* P_b );
