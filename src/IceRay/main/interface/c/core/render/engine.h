...
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool            IceRayC_Render_Engine_Release( IceRayC_Render_Engine_Handle P_this );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Render_Engine_Handle IceRayC_Render_Engine0();
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool            IceRayC_Render_Engine_Scanner(  IceRayC_Render_Engine_Handle P_this, IceRayC_Render_Scanner_Handle P_scanner );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool            IceRayC_Render_Engine_Pixel(    IceRayC_Render_Engine_Handle P_this, IceRayC_Render_Pixel_Handle   P_pixel );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool            IceRayC_Render_Engine_Pierce(   IceRayC_Render_Engine_Handle P_this, IceRayC_Render_Pierce_Handle  P_perce );
IceRayC__EXPORT IceRayC__DECLSPEC  IceRayC_Type_Bool            IceRayC_Render_Engine_Sheaf(    IceRayC_Render_Engine_Handle P_this, IceRayC_Render_Sheaf_Handle   P_sheaf );
