#ifndef Dh_DDMRM_Iceray_utility_table_random_HPP_
 #define Dh_DDMRM_Iceray_utility_table_random_HPP_

 // GS_DDMRM::S_IceRay::S_utility::S_table::GC_random
         ...
         class GC_random
          {
           ...
           public:
             explicit GC_random( T_size const& P_size = 15 )
              {
               F_init( P_size );
              }
           public:
