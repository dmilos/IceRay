#ifndef Dh_DDMRM_Iceray_utility_table_sunflower_HPP_
 #define Dh_DDMRM_Iceray_utility_table_sunflower_HPP_

 // GS_DDMRM::S_IceRay::S_utility::S_table::GC_sunflower
         ...
         class GC_sunflower
          {
           ...
           public:
             explicit GC_sunflower( T_size const& P_size = 15 )
              {
               F_init( P_size );
              }
           public:
