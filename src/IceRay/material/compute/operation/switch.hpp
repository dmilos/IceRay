         ...
         namespace S_operation
          {
             ...
             class GC_switch
              : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
              {
               ...
               public:
                 GC_switch
                 (
                   T_size const& P_inValue             = 0
                  ,T_size const& P_inCandidateStart    = 2
                  ,T_size const& P_outResult           = 1
                 )
                 {
            ...
            typedef GS_DDMRM::S_IceRay::S_material::S_compute::S_operation::GC_switch< GS_DDMRM::S_IceRay::S_type::GT_size              > GT_switchSize;
            typedef GS_DDMRM::S_IceRay::S_material::S_compute::S_operation::GC_switch< GS_DDMRM::S_IceRay::S_type::GT_scalar            > GT_switchScalar;
            typedef GS_DDMRM::S_IceRay::S_material::S_compute::S_operation::GC_switch< GS_DDMRM::S_IceRay::S_type::S_color::GT_scalar   > GT_switchColor;
          //typedef GS_DDMRM::S_IceRay::S_material::S_compute::S_operation::GC_switch< GS_DDMRM::S_IceRay::S_type::S_coord::GT_scalar2D > GT_switchCoord2D;
            typedef GS_DDMRM::S_IceRay::S_material::S_compute::S_operation::GC_switch< GS_DDMRM::S_IceRay::S_type::S_coord::GT_scalar   > GT_switchCoord3D;

          //typedef GS_DDMRM::S_IceRay::S_material::S_compute::S_operation::GC_switch< GS_DDMRM::S_IceRay::S_type::S_coord::GT_size2D > GT_switchCell2D;
          //typedef GS_DDMRM::S_IceRay::S_material::S_compute::S_operation::GC_switch< GS_DDMRM::S_IceRay::S_type::S_coord::GT_size3D > GT_switchCell3D;
