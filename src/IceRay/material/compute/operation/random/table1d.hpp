#ifndef Dh_DDMRM_Iceray_material_compute_operation_random_table1d_HPP_
 #define Dh_DDMRM_Iceray_material_compute_operation_random_table1d_HPP_

// GS_DDMRM::S_IceRay::S_material::S_compute::S_operation::S_random::GC_table1d
           ...
           namespace S_random
            {
             ...
             class GC_table1d
              : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
              {
                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   for( T_size I_index = 0; I_index < I_count; ++I_index )
                    {
                     // TODO M2_memoryScalar->Fv_store( I_leader + I_index,  M2_generator.next() );
                    }
                   return true;
                  }
               ...
               private:
                 // TODO mutable GS_DDMRM::S_IceRay::S_utility::S_random::GC_table1d1D  M2_generator;
              };
