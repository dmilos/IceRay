#ifndef Dh_DDMRM_Iceray_material_compute_operation_random_congruent1d_HPP_
 #define Dh_DDMRM_Iceray_material_compute_operation_random_congruent1d_HPP_

// GS_DDMRM::S_IceRay::S_material::S_compute::S_operation::S_random::GC_congruent1d
