#ifndef Dh_DDMRM_Iceray_material_compute_operation_random_sobol2d_HPP_
 #define Dh_DDMRM_Iceray_material_compute_operation_random_sobol2d_HPP_
           ...
           namespace S_random
            {
             ...
             class GC_sobol2d
              : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
              {
                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   for( T_size I_index = 0; I_index < I_count; ++I_index )
                    {
                     auto & I_point = M2_memoryCoord2D->Fv_direct( I_leader + I_index );
                     M2_generator.next( I_point[0], I_point[1] );
                    }
                   return true;
                  }
               ...
               private:
                 mutable GS_DDMRM::S_IceRay::S_utility::S_random::GT_sobol2D M2_generator;
              };
