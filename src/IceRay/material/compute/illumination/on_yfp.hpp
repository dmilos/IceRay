#ifndef Dh_DDMRM_Iceray_material_compute_illumination_ON_Fujii_Proposed_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_ON_Fujii_Proposed_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/OrenNayar/FujiiProposed.hpp"
                   ...
                   bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                    {
                     ...
                     GS_DDMRM::S_IceRay::S_material::S_illumination::S_OrenNayar::S_Fujii::GC_proposed  I_yfp( I_rho, I_sigma );
