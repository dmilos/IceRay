#ifndef Dh_DDMRM_Iceray_material_compute_illumination_CookTorrance_schlick_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_CookTorrance_schlick_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/CookTorrance/schlick.hpp"
