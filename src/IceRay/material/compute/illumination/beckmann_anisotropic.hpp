#ifndef Dh_DDMRM_Iceray_material_compute_illumination_beckmann_anisotropic_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_beckmann_anisotropic_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/beckmann/anisotropic.hpp"
                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   GS_DDMRM::S_IceRay::S_material::S_illumination::S_beckmann::GC_anisotropic I_beckmann( I_specular, I_roughnessX, I_roughnessY );
