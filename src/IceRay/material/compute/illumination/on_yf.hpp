#ifndef Dh_DDMRM_Iceray_material_compute_illumination_ON_YF_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_ON_YF_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/OrenNayar/YasuhiroFujii.hpp"
