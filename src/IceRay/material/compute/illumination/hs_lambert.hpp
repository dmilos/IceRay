#ifndef Dh_DDMRM_Iceray_material_compute_illumination_HeidrichSeidel_Lambert_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_HeidrichSeidel_Lambert_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/HeidrichSeidel/lambert.hpp"
             ...
             class GC_Lambert
              : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
              {
               public:
                 ...
                 enum Ee_input
                  {
                   En_inColor_Diffuse = 1, En_inCoord_Groove = 2,
