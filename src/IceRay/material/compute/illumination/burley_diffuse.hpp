#ifndef Dh_DDMRM_Iceray_material_compute_illumination_Burley_diffuse_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_Burley_diffuse_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/burley/diffuse.hpp"
             ...
             class GC_diffuse
              : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
              {
               public:
                 ...
                 enum Ee_input
                  {
                   En_inColor_Diffuse = 0, En_inScalar_Roughness = 1,
               ...
               public:
                 GC_diffuse
                  (
                   ...
                   ,T_size const& P_diffuse   = 0
                   ,T_size const& P_roughness  = 1
                  )
                  {
                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   GS_DDMRM::S_IceRay::S_material::S_illumination::S_burley::GC_diffuse I_burley( I_diffuse, I_roughness );
