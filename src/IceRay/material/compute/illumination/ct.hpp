#ifndef Dh_DDMRM_Iceray_material_compute_illumination_CookTorrance_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_CookTorrance_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/CookTorrance/specular.hpp"
                 ...
                 enum Ee_input
                  {
                   ...
                   En_inColor_Specular = 0, En_inColor_Roughness = 1,
                   En_inScalar_IOR
                  };
               ...
               public:
                 GC_CookTorrance
                  (
                   ...
                   ,T_size const& P_inColor_Specular
                   ,T_size const& P_inColor_Roughness
                   ,T_size const& P_inScalar_IOR
                  )
                  {
                   ...
                   F_input<T_color>( En_inColor_Specular,      P_inColor_Specular     );
                   F_input<T_color>( En_inColor_Roughness,     P_inColor_Roughness    );
                   F_input<T_scalar>( En_inScalar_IOR,          P_inScalar_IOR         );
                  }
                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   T_color I_color;
                   T_coord I_2light, I_half;
                   T_color I_energy;

                   GS_DDMRM::S_IceRay::S_material::S_illumination::S_CookTorrance::GC_specular I_ct( I_specular, I_roughness, I_ior );
                   ...
                   for( T_size I_spotIndex = I_spotBegin; I_spotIndex < I_spotEnd; ++I_spotIndex )
                    {
                     ...
                     I_ct.F_process(  I_color, I_energy, I_normal, I_2viewer, I_2light, I_half );
