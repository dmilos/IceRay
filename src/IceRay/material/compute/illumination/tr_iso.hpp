#ifndef Dh_DDMRM_Iceray_material_compute_illumination_TrowbridgeReitz_isotropic_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_TrowbridgeReitz_isotropic_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/TrowbridgeReitz/isotropic.hpp"
             ...
             class GC_isotropic
              : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
              {
               public:
                 ...
                 enum Ee_input
                  {
                   En_inColor_Specular = 0, En_inScalar_Roughness = 1,
                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   GS_DDMRM::S_IceRay::S_material::S_illumination::S_TrowbridgeReitz::GC_isotropic I_isotropic( I_specular, I_roughness );
                   ...
                   for( T_size I_spotIndex = I_spotBegin; I_spotIndex < I_spotEnd; ++I_spotIndex )
                    {
                     ...
                     if( true == I_isotropic.F_process( I_color, I_energy, I_normal, I_half ) )
                      {
                       I_summae += I_color;
                       I_valid = true;
                      }
