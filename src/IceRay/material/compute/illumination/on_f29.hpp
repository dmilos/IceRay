                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   GS_DDMRM::S_IceRay::S_material::S_illumination::S_OrenNayar::GC_f29  I_f29( I_rho, I_sigma );
                   ...
                   for( T_size I_spotIndex = I_spotBegin; I_spotIndex < I_spotEnd; ++I_spotIndex )
                    {
                     ...
                     if( true == I_f29.F_process( I_color, I_energy, I_normal, I_2light, I_2viewer ) )
                      {
                       I_summae += I_color;
                      }
                    }
