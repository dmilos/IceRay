#ifndef Dh_DDMRM_Iceray_material_compute_illumination_beckmann_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_beckmann_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/beckmann/isotropic.hpp"
               ...
               public:
                 GC_isotropic
                  ...
                  )
                  {
                   ...
                   F_input<T_color>( En_inColor_Roughness,   P_roughness );
                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   GS_DDMRM::S_IceRay::S_material::S_illumination::S_beckmann::GC_isotropic I_beckmann( I_specular, I_roughness );
