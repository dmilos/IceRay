#ifndef Dh_DDMRM_Iceray_material_compute_illumination_AshikhminPremozeShirley_velvet_HPP_
 #define Dh_DDMRM_Iceray_material_compute_illumination_AshikhminPremozeShirley_velvet_HPP_

 #include <tuple>
 #include <limits>

 #include "../../illumination/aps/velvet.hpp"
       ...
       namespace S_compute
        {
         namespace S_illumination
          {
           namespace S_AshikhminPremozeShirley
            {
                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   //GS_DDMRM::S_IceRay::S_material::S_illumination::S_AshikhminPremozeShirley::GC_velvet I_velvet( TODO );
