           ...
           class GC_intersect
            : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
            {
             ...
             public:
               GC_intersect()
                {
                 F_input( T_memory::T_component::En_geometryIntersect, En_inGeometryIntersect_This,  0 );
                 F_input( T_memory::T_component::En_ray,               En_inRay_Incoming,  0 );
               ...
               bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                {
                 ...
                 T_ray     const&   I_ray      = M2_memoryRay->Fv_load(      F_input()[ T_memory::T_component::En_ray              ][ En_inRay_Incoming ] );
                 T_geometry const  *I_geometry = M2_memoryGeometry->Fv_load( F_input()[ T_memory::T_component::En_geometryIntersect][ En_inGeometryIntersect_This ] );
               ...
               void    Fv_memory( T_memory * P_memory  )
                {
                 ...
                 M2_memoryRay      = dynamic_cast<T2_memoryRay * >( P_memory->F_get( T_memory::T_component::En_ray ) );
                 M2_memoryGeometry = dynamic_cast<T2_memoryGeometryIntersect * >( P_memory->F_get( T_memory::T_component::En_geometryIntersect ) );
                }
