                 ...
                 public:
                   ...
                   //,T_size const& P_outRay_refracted = 1
                    )
                    {
                     ...
                     F_input<T_color>(  En_inColor_Attenuation,   P_attenuation        );
                   ...
                   bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                    {
...

                     {
                      ...
                      ::color::operation::multiply( I_refracted.M_intesity, I_attenuation, I_incoming.M_intesity );
