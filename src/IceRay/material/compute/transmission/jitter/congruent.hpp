#ifndef Dh_DDMRM_Iceray_material_compute_transmission_jitter_congruent_HPP_
 #define Dh_DDMRM_Iceray_material_compute_transmission_jitter_congruent_HPP_

// GS_DDMRM::S_IceRay::S_material::S_compute::S_transmission::S_jitter::GC_congruent
           ...
           namespace S_jitter
            {
             ...
             class GC_congruent //! Use rays and congruently move them inside their cone. Do not fix!
