#ifndef Dh_DDMRM_Iceray_material_compute_transmission_jitter_general_HPP_
 #define Dh_DDMRM_Iceray_material_compute_transmission_jitter_general_HPP_

// GS_DDMRM::S_IceRay::S_material::S_compute::S_transmission::S_jitter::GC_general
           ...
           namespace S_jitter
            {
             ...
             class GC_general //! Use rays and randomly move them inside their cone. Do not fix!
              : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
              {
               ...
               public:
                 GC_general
                  (
                   ...
                   ,T_size const& P_inLeaderR       //= 0
                   ,T_size const& P_inLeaderD      //= 0
                 ...
                 //,T_size const& P_inGauss        //= 1
                  )
                  {
                   ...
                   F_input<T_size>(    En_inSize_LeaderR,  P_inLeaderR      );
                   F_input<T_size>(    En_inSize_LeaderD,  P_inLeaderD      );
               ...
               public:
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   T_size   const& I_leaderR = M2_memorySize->Fv_load(    F_input< T_size   >( En_inSize_LeaderR ) );
                   T_size   const& I_leaderD = M2_memorySize->Fv_load(    F_input< T_size   >( En_inSize_LeaderD ) );
                 ...
                 //T_scalar const& I_gauss  = M2_memoryScalar->Fv_load(  F_input<T_scalar>( En_inScalar_Gauss ) );
                   ...
                   T_coord2D I_disc2d;
                   T_scalar I_radius = sin( I_angle );


                   for( T_size I_index= 0; I_index < I_count; ++I_index )
                    {
                     auto      & I_original = P_next.Fv_expose( I_index + I_leaderR );
                     ...
                     I_disc2d = M2_memoryCoord2D->Fv_load( I_leaderD + I_index );
