#ifndef Dh_DDMRM_Iceray_material_compute_transmission_reflect_diffusive_HPP_
 #define Dh_DDMRM_Iceray_material_compute_transmission_reflect_diffusive_HPP_
                 ...
                 public:
                   ...
                   //,T_size const& P_outSize_RayCount  // = 1
                    ...
                    )
                    {
                     ...
                     F_input<T_scalar>( En_inScalar_Coefficient, P_coefficient );
                   ...
                   bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                    {
                     ...
                     T_scalar const& I_cefficient= M2_memoryScalar->Fv_load( F_input<T_scalar>( En_inScalar_Coefficient ) );
                     ...
                     ::math::linear::vector::convex( I_reflected.M_direction, I_cefficient, I_reflected.M_direction, I_normal );
