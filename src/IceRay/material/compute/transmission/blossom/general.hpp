//TODO 
#ifndef Dh_DDMRM_Iceray_material_compute_transmission_blossom_general_HPP_
 #define Dh_DDMRM_Iceray_material_compute_transmission_blossom_general_HPP_

// GS_DDMRM::S_IceRay::S_material::S_compute::S_transmission::S_blossom::GC_general
           ...
           namespace S_blossom
            {
             ...
             class GC_general
              : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
              {
                 ...
                 bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                  {
                   ...
                   auto      & I_original = P_next.Fv_expose( I_leaderR );
                   F_execute
                    (
                      P_next
                     ,I_normal
               ...
               private:
                 mutable GS_DDMRM::S_IceRay::S_utility::S_random::GT_general2D       M2_randgeneral2D;
