#ifndef Dh_DDMRM_Iceray_material_compute_transmission_blossom_congruent_HPP_
 #define Dh_DDMRM_Iceray_material_compute_transmission_blossom_congruent_HPP_

// GS_DDMRM::S_IceRay::S_material::S_compute::S_transmission::S_blossom::GC_congruent
                   ...
                   for( T_size I_index=0; I_index < I_count; ++I_index )
                    {
                     ...
                     T_scalar I_distance = P_angle * ::math::linear::vector::length( I_disc2d );
