#ifndef Dh_DDMRM_Iceray_material_compute_transmission_blossom_sobol_HPP_
 #define Dh_DDMRM_Iceray_material_compute_transmission_blossom_sobol_HPP_

// GS_DDMRM::S_IceRay::S_material::S_compute::S_transmission::S_blossom::GC_sobol
