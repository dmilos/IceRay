#ifndef Dh_DDMRM_Iceray_material_compute_Setup_2viewer_HPP_
 #define Dh_DDMRM_Iceray_material_compute_Setup_2viewer_HPP_
               ...
               bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                {
                 ...
                 ::math::linear::vector::negate( M2_memoryCoord->Fv_direct( En_inCoord3D_Dynamic_2Viewer ), I_direction );
