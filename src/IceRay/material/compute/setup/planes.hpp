#ifndef Dh_DDMRM_Iceray_material_compute_Setup_PlaneSurface_HPP_
 #define Dh_DDMRM_Iceray_material_compute_Setup_PlaneSurface_HPP_
               ...
               bool    Fv_execute( T_beam &P_next, T_pigment::T_intersect const& P_intersect, T_state const& P_state )const
                {
                 ...
                 auto & I_X = M2_memoryCoord->Fv_direct( En_inCoord3D_Dynamic_Surface_X );
                 ::math::linear::vector::cross( I_X, I_direction, I_normal );   ::math::linear::vector::length( I_X, T_scalar(1) );
                 auto & I_Y = M2_memoryCoord->Fv_direct( En_inCoord3D_Dynamic_Surface_Y );
                 ::math::linear::vector::cross( I_Y, I_normal,     I_X );       ::math::linear::vector::length( I_Y, T_scalar(1) );
