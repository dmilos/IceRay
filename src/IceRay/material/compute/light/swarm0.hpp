       ...
       namespace S_compute
        {
         namespace S_light
          {
           // Create spots from light. Do cull optionally
           class GC_swarm0
            : public GS_DDMRM::S_IceRay::S_material::S_compute::GC_instruction
            {
               ...
               enum Ee_input
                {
                 ...
                 En_inSize_SpotStart = 0, En_inSize_SpotLimit=1,
                 En_inLight_Light = 0
                };
             ...
             public:
               ...
               //,T_size const& En_inSize_SpotStart = 0
               //,T_size const& En_inSize_SpotLimit = 1
                 ,T_size const& P_inCull = 0
                 ,T_size const& P_outSpot_Count = 0
                )
                {
                 F_input<T_bool>(   En_inBool_Cull,  P_inCull );
                 F_input<T_coord>(  En_inCoord_Point,  0 );
                 F_input<T_coord>(  En_inCoord_Normal, 1 );
                 F_input<T_size>(   En_inSize_SpotStart,   0 );
                 F_input<T_size>(   En_inSize_SpotLimit,   1 );
             ...
             public:
               ...
               //T_ray     const&   I_ray      = M2_memoryRay->Fv_load( F_input()[ T_memory::En_ray ][ En_inRay_incoming] );
                 ...
                 T_bool const& I_cull    = true; // TODO M2_memoryBool->Fv_load( F_input()[ T_memory::En_bool][ En_inBool_Cull ] );
                 T_coord const& I_point  = M2_memoryCoord->Fv_load( F_input()[ T_memory::En_coord ][ En_inCoord_Point ] );
                 T_coord        I_normal = M2_memoryCoord->Fv_load( F_input()[ T_memory::En_coord ][ En_inCoord_Normal ] );
                 T_size const& I_start   =  0;       //M2_memorySize->Fv_load( F_input()[ T_memory::En_size ][ En_inSize_SpotStart ] );
                 T_size const& I_limit   = -1;       //M2_memorySize->Fv_load( F_input()[ T_memory::En_size ][ En_inSize_SpotLimit ] );
                 ...
                 T_size I_count = 0;
                 M2_memorySize->Fv_store( F_output<T_size>( En_outSize_SpotCount ), 0 );
