             ...
             public:
               bool F_process
                ...
                )
                {
                 ...
                 P_result.set( 0, P_energy[0] * M2_specular[0] * T_scalar(1) /( I_c * M2_iA2[0] ) * exp( I_e /( M2_iA2[0] ) ) );
                 P_result.set( 1, P_energy[1] * M2_specular[1] * T_scalar(1) /( I_c * M2_iA2[1] ) * exp( I_e /( M2_iA2[1] ) ) );
                 P_result.set( 2, P_energy[2] * M2_specular[2] * T_scalar(1) /( I_c * M2_iA2[2] ) * exp( I_e /( M2_iA2[2] ) ) );
