       ...
       namespace S_pattern
        {
         ...
         class GC_hexagon
          ...
          {// DONE
           public:
             GC_hexagon( T_scalar const& P_scale = 1 ): M2_scale( P_scale )
              {
              }
             ...
             void  Fv_process( T_result &P_result, T_coord const& P_coord )const
              {
               ...
               T_scalar I_x = P_coord[0] * M2_scale;
               T_scalar I_y = P_coord[1] * M2_scale;
           ...
           public:
             T_scalar const& F_scale( T_scalar const& P_scale )const
              {
               return M2_scale;
              }
             bool F_scale( T_scalar const& P_scale )
              {
               M2_scale = P_scale;
               return true;
              }
