...
def SearchCDLL( P_path = None ):
    ...
    if( 'Windows' == platform.system() ):
        ...
        bin_root  = "../.."                             #!< cmake VS
        bin_dir   = "build/cmake/_makeVS/cdll/Release"  #!< cmake VS
        bin_dll   = "IceRayDLL-1.0.0.0.dll"             #!< cmake VS
        bin_test = bin_root +'/'+ bin_dir +'/'+ bin_dll
        print( "DLL test: "+ str( os.path.exists( bin_test ) )  + "\'"+ " -> "+ bin_test, flush = True  )
        if( True == os.path.exists( bin_test ) ):
        ...
        bin_root  = os.getcwd() + "/../../" + "build/cmake/_makeVS/cdll"           #!< cmake VS
        bin_dir   = "Debug"    #!< cmake VS
        bin_dll   = "IceRayDLL-1.0.0.0.dll"             #!< cmake VS
        bin_test = bin_root +'/'+ bin_dir +'/'+ bin_dll
        print( "DLL test: "+ str( os.path.exists( bin_test ) )  + "\'"+ " -> "+ bin_test, flush = True  )
        if( True == os.path.exists( bin_test ) ):
...
def _MapFunction_Camera( P_dll ):
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Horizontal0             , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Horizontal1             , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Horizontal2             , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Horizontal_Radius       , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Horizontal_Theta        , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Horizontal_Width        , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Vertical0               , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Vertical1               , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Vertical2               , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Vertical_Height         , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Vertical_Phi            , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Cylinder_Vertical_Radius         , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cone0                        , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cone1                        , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cone2                        , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cone3                        , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cone_Aperture                , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cone_Child                   , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cone_Gauss                   , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cone_Sample                  , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cylinder0                    , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cylinder1                    , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cylinder2                    , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cylinder3                    , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cylinder_Aperture            , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cylinder_Child               , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cylinder_Gauss               , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Cylinder_Sample              , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Focus0                       , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Focus1                       , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Focus2                       , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Focus_Aperture               , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Focus_Child                  , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Focus_Focus                  , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Focus_Gauss                  , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_DOF_Focus_Sample                 , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Orthogonal0                 , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Orthogonal_Aspect           , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Orthogonal_Height           , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Orthogonal_Width            , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Perspective0                , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Perspective1                , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Perspective2                , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Perspective_Aspect          , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Perspective_Height          , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Perspective_Width           , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Super0                      , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Super_Eye                   , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Super_Focus                 , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Super_Objective             , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Super_Ocular                , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Flat_Super_View                  , ctypes.c_int       , [ctypes.c_void_p] )
    ...
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Fisheye1                  , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Fisheye2                  , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Fisheye_Phi               , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Fisheye_Radius            , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Fisheye_Theta             , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Horizontal0               , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Horizontal1               , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Horizontal_Phi            , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Horizontal_Radius         , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Horizontal_Theta          , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Vertical0                 , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Vertical1                 , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Vertical2                 , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Vertical_Phi              , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Vertical_Radius           , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Sphere_Vertical_Theta            , ctypes.c_int       , [ctypes.c_void_p] )
    ...
    _MakeFunction( P_dll.IceRayC_Camera_Transform_Invert1                , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Transform_Invert_Child           , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Transform_Pin0                   , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Transform_Pin1                   , ctypes.c_void_p    , [] )
    _MakeFunction( P_dll.IceRayC_Camera_Transform_Pin_Child              , ctypes.c_int       , [ctypes.c_void_p] )
    _MakeFunction( P_dll.IceRayC_Camera_Transform_Pin_Origin             , ctypes.c_int       , [ctypes.c_void_p] )
    return

def _MapFunction_Light( P_dll ):
    _MakeFunction(P_dll.IceRayC_Light_Area0                             ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Area_Origin                       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Area_Sample                       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Area_Spot                         ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Area_X                            ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Area_Y                            ,      ctypes.c_int,    [ctypes.c_void_p] )
    ...
    _MakeFunction(P_dll.IceRayC_Light_Disc_Center                       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Disc_Sample                       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Disc_Spot                         ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Disc_X                            ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Disc_Y                            ,      ctypes.c_int,    [ctypes.c_void_p] )
    ...
    _MakeFunction(P_dll.IceRayC_Light_Line_Sample                       ,      ctypes.c_int,    [ctypes.c_void_p] )
    ...
    _MakeFunction(P_dll.IceRayC_Light_Point1                            ,      ctypes.c_void_p, [] )
    ...
    _MakeFunction(P_dll.IceRayC_Light_Reflector_Center                  ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Reflector_Direction               ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Reflector_Inner                   ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Reflector_Outter                  ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Reflector_Spot                    ,      ctypes.c_int,    [ctypes.c_void_p] )
    ...
    _MakeFunction(P_dll.IceRayC_Light_Sphere1                           ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Sphere2                           ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Sphere3                           ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Sphere_Radius                     ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Sphere_Sample                     ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Sphere_Spot                       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Spline0                           ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Spline_CP                         ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Spline_Sample                     ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Spline_Spot                       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_SunG0                             ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_SunG1                             ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_SunG_Child                        ,      ctypes.c_int,    [] )
    _MakeFunction(P_dll.IceRayC_Light_SunS0                             ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_SunS1                             ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_SunS_Center                       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_SunS_Spot                         ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Affine0                 ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Affine1                 ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Affine2                 ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Affine_2Local_Get       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Affine_2Local_Set       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Affine_2World_Get       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Affine_2World_Set       ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Affine_Child            ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Homography0             ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Homography_2Local_Get   ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Homography_2Local_Set   ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Homography_2World_Get   ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Homography_2World_Set   ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Homography_Child        ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Identity0               ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Identity1               ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Identity_Child          ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Translate0              ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Translate1              ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Translate2              ,      ctypes.c_void_p, [] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Translate_2Local_Get    ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Translate_2Local_Set    ,      ctypes.c_int,    [ctypes.c_void_p] )
    _MakeFunction(P_dll.IceRayC_Light_Transform_Translate_2World_Get    ,      ctypes.c_int,    [ctypes.c_void_p] )
...
def _MapFunction_Geometry( P_dll ):
    ...
    _MakeFunction( P_dll.IceRayC_Geometry_Complex_Enclose1                    , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Complex_Enclose_Child               , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Complex_Enclose_Hull                , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Complex_Intersect0                  , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Complex_Intersect1                  , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Complex_Intersect_Left0             , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Complex_Intersect_Left1             , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Complex_Intersect_Right0            , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Complex_Intersect_Right1            , ctypes.c_void_p  , [] )#!<mTODO
    ...
    _MakeFunction( P_dll.IceRayC_Geometry_HField                              , ctypes.c_int     , [] )
    ...
    _MakeFunction( P_dll.IceRayC_Geometry_Hyperboloid_Core                    , ctypes.c_int     , [] )
    ...
    _MakeFunction( P_dll.IceRayC_Geometry_Plane_Normal                        , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Plane_Origin                        , ctypes.c_int     , [] )
    ...
    _MakeFunction( P_dll.IceRayC_Geometry_Torus_Minor                         , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Affine0                   , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Affine1                   , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Affine_2Local_Get         , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Affine_2Local_Set         , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Affine_2World_Get         , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Affine_2World_Set         , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Affine_Child              , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Homography0               , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Homography1               , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Homography_2Local_Get     , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Homography_2Local_Set     , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Homography_2World_Get     , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Homography_2World_Set     , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Homography_Child          , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Identity0                 , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Identity1                 , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Identity_Child            , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_MotionBlur0               , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_MotionBlur1               , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_MotionBlur2               , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_MotionBlur_Child          , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_MotionBlur_Direction      , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Translate0                , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Translate1                , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Translate2                , ctypes.c_void_p  , [] )#!<mTODO
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Translate_2Local_Get      , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Translate_2Local_Set      , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Translate_2World_Get      , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Translate_2World_Set      , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Transform_Translate_Child           , ctypes.c_int     , [] )
    ...
    _MakeFunction( P_dll.IceRayC_Geometry_UCylinder0                          , ctypes.c_void_p  , [] )
    ...
    _MakeFunction( P_dll.IceRayC_Geometry_UTriangle0                          , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Mist0                    , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Mist1                    , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Mist2                    , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Mist3                    , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Mist4                    , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Mist5                    , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Mist_Density             , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Mist_Hull                , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Mist_Precision           , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Smoke0                   , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Smoke2                   , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Smoke_Hull               , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Vacuum0                  , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Vacuum1                  , ctypes.c_void_p  , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Vacuum_Box               , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Vacuum_Hi                , ctypes.c_int     , [] )
    _MakeFunction( P_dll.IceRayC_Geometry_Volumetric_Vacuum_Lo                , ctypes.c_int     , [] )

    pass

def _MapFunction_Object(P_dll):
...
def _MapFunction_Render(P_dll):
    ...
    _MakeFunction( P_dll.IceRayC_Render_Engine_Progress           , ctypes.c_int     , [ctypes.c_void_p] )
...
def _MapFunction_Type_Math(P_dll):
...
def _MapFunction_Type_Picture(P_dll):
    ...
    _MakeFunction( P_dll.IceRayC_Type_Picture_Crop0      , ctypes.c_int    , [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p] )
...
def _MapFunction_Type(P_dll):
    _MapFunction_Type_Math(P_dll)
    _MapFunction_Type_Picture(P_dll)
    return

def _MapFunction_Material_Medium(P_dll):
...
def _MapFunction_Material_Pigment_Surface(P_dll):
...
def _MapFunction_Material_Pigment_Surface_Instruction_Convert(P_dll): #!< todo
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Bool2Bool0                         , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Bool2Color0                        , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Bool2Coord2D0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Bool2Coord3D0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Bool2Integer0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Bool2Scalar0                       , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Bool2Size0                         , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Color2Bool0                        , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Color2Color0                       , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Color2Coord2D0                     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Color2Coord3D0                     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Color2Integer0                     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Color2Scalar0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Color2Size0                        , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord2D2Bool0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord2D2Color0                     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord2D2Coord2D0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord2D2Coord3D0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord2D2Integer0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord2D2Scalar0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord2D2Size0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord3D2Bool0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord3D2Color0                     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord3D2Coord2D0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord3D2Coord3D0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord3D2Integer0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord3D2Scalar0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Coord3D2Size0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Integer2Bool0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Integer2Color0                     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Integer2Coord2D0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Integer2Coord3D0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Integer2Integer0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Integer2Scalar0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Integer2Size0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Scalar2Bool0                       , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Scalar2Color0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Scalar2Coord2D0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Scalar2Coord3D0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Scalar2Integer0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Scalar2Scalar0                     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Scalar2Size0                       , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Size2Bool0                         , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Size2Color0                        , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Size2Coord2D0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Size2Coord3D0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Size2Integer0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Size2Scalar0                       , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Convert_Size2Size0                         , ctypes.c_void_p , [ctypes.c_bool] )
    return
...
def _MapFunction_Material_Pigment_Surface_Instruction_Illumination(P_dll):
    ...
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Illumination_ON_Fujii_Proposed             , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Illumination_ON_Fujii_Qualitative          , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Illumination_ON_Ouwerkerk                  , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Illumination_ON_f29                        , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Illumination_ON_f30                        , ctypes.c_void_p , [ctypes.c_bool] )
    ...
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Illumination_WardApprox0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Illumination_WardIsotropic0                , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Illumination_WardReal0                     , ctypes.c_void_p , [ctypes.c_bool] )

def _MapFunction_Material_Pigment_Surface_Instruction_Light(P_dll):
...
def _MapFunction_Material_Pigment_Surface_Instruction_Operation(P_dll):
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Clamp_Ramp0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Clamp_Relu0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Clamp_Saw0                       , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Clamp_Sinkhole0                  , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Clamp_Wave0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Affine3D0                , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Affine3D1                , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cartesian2Cylindric0     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cartesian2Fisheye0       , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cartesian2Package0       , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cartesian2Spherical0     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cartesian2Tablecloth0    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cartesian2Torus0         , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cartesian2WoodX0         , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cartesian2WoodY0         , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cartesian2WoodZ0         , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cylindric2Cartesian0     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Cylindric2Spherical0     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Euclid2Max0              , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Homography3D0            , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Homography3D1            , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Identity3D0              , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Max2Euclid0              , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Spherical2Cartesian0     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Spherical2Cylindric0     , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Translate3D0             , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Translate3D1             , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Mapping_Translate3D_Move         , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Switch_Color0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Switch_Coord2D0                  , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Switch_Coord3D0                  , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Switch_Scalar0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Operation_Switch_Size0                     , ctypes.c_void_p , [ctypes.c_bool] )

def _MapFunction_Material_Pigment_Surface_Instruction_Pattern(P_dll):
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Pattern_Color0                             , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Pattern_Coord_Scalar2D0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Pattern_Coord_Scalar3D0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Pattern_Coord_Size2D0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Pattern_Coord_Size3D0                      , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Pattern_Scalar0                            , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Pattern_Size0                              , ctypes.c_void_p , [ctypes.c_bool] )

def _MapFunction_Material_Pigment_Surface_Instruction_Spot(P_dll):
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Spot_Confine0                              , ctypes.c_void_p , [ctypes.c_bool] )
    ...
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Spot_UWV0                                  , ctypes.c_void_p , [ctypes.c_bool] )

def _MapFunction_Material_Pigment_Surface_Instruction_Transmission(P_dll):
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Blossom_Grid0                 , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Blossom_Hexagon0              , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Blossom_Pinwheel0             , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Blossom_Random0               , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Blossom_Triangle0             , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Blossom_VDC0                  , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Corrector0                    , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Jitter_Random0                , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Jitter_VDC0                   , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Reflect_One0                  , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Reflect_Schlick0              , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Refract_Fresnel0              , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Refract_Schlick0              , ctypes.c_void_p , [ctypes.c_bool] )
    _MakeFunction( P_dll.IceRayC_Material_Pigment_Surface_Instruction_Transmission_Refract_Snell0                , ctypes.c_void_p , [ctypes.c_bool] )

def _MapFunction_Material_Pigment_Surface_Instruction(P_dll):
...
def _MapFunction_Material_Pigment(P_dll):
...
def _MapFunction_Material(P_dll):
