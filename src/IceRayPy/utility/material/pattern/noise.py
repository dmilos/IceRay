...
def Congruent3D(
    ...
    I_pattern = IceRayPy.core.material.pattern.noise.Congruent3D( P_dll )
    ...
    I_surface = IceRayPy.core.material.pigment.Surface( P_dll )
    I_surface.append( IceRayPy.core.material.instruction.pattern.Coord3D( P_dll, I_pattern, value, point ) )
    I_surface.append( IceRayPy.core.material.instruction.convert.Coord3D2Color( P_dll, result, value ) )
