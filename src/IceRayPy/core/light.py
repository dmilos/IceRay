...
class Area:
    ...
    def sample( self, P_sample ):
        self.m_cargo['dll'].IceRayC_Light_Area_Sample( self.m_cargo['this'], Unsigned( P_sample ) )
...
class Blocked:
    def __init__( self, P_dll, P_barrier = None ):
        self.m_cargo = {}
        self.m_cargo['dll'] = P_dll
    ...
    def barrier( self, P_barrier ):
        self.m_cargo['dll'].IceRayC_Light_Blocked_Barrier( self.m_cargo['this'], P_barrier.m_cargo['this'] )
...
class Circle:
    ...
    def sample( self, P_sample ):
        self.m_cargo['dll'].IceRayC_Light_Circle_Sample( self.m_cargo['this'], Unsigned( P_sample ) )
...
class Confine:
    ...
    def child( self, P_child ):
        self.m_cargo['dll'].IceRayC_Light_Confine_Hull( self.m_cargo['this'], P_child.m_cargo['this'] )
    ...
    def location( self, P_location ):
        self.m_cargo['dll'].IceRayC_Light_Confine_Hull( self.m_cargo['this'], Unsigned(  self, P_location ) )
...
class Disc:
    ...
    def sample( self, P_sample ):
        self.m_cargo['dll'].IceRayC_Light_Disc_Sample( self.m_cargo['this'], Unsigned( P_sample ) )
...
class Line:
    ...
    def sample( self, P_sample ):
        self.m_cargo['dll'].IceRayC_Light_Line_Sample( self.m_cargo['this'], Unsigned ( P_sample ) )
...
class Point:
    ...
    def center( self, P_center ):
        self.m_cargo['dll'].IceRayC_Light_Point_Spot( self.m_cargo['this'], AddresOf( P_center ) )
...
class Reflector:
    ...
    def inner( self, P_inner ):
        self.m_cargo['dll'].IceRayC_Light_Reflector_Inner( self.m_cargo['this'], Scalar( P_inner ) )

    def outter( self, P_outter ):
        self.m_cargo['dll'].IceRayC_Light_Reflector_Outter( self.m_cargo['this'], Scalar( P_outter ) )
...
class Sphere:
    ...
    def sample( self, P_sample ):
        self.m_cargo['dll'].IceRayC_Light_Sphere_Sample( self.m_cargo['this'], Unsigned( P_sample ) )
...
class Spline:
    ...
    def sample( self, P_sample ):
        self.m_cargo['dll'].IceRayC_Light_Spline_Sample( self.m_cargo['this'], Unsigned( P_sample ) )

    def cp( self, P_index, P_p0 : Coord3D ):
        self.m_cargo['dll'].IceRayC_Light_Spline_CP( self.m_cargo['this'], Unsigned( P_index ), AddresOf( P_p0 ) )
