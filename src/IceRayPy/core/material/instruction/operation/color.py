...
class Subtraction:
    def __init__( self, P_dll, P_result, P_left, P_right ):
        self.m_cargo = {}
        self.m_cargo['dll'] = P_dll
        self.m_cargo['this'] = self.m_cargo['dll'].IceRayC_Material_Pigment_Surface_Instruction_Operation_Color_Subtraction0( SizeType( P_result ), SizeType( P_left ), SizeType( P_right ) )
