...
class Beckmann_Isotropic:
    def __init__( self, P_dll, P_result, P_point, P_normal, P_spotBegin, P_spotEnd, P_specular, P_roughness ):
        self.m_cargo = {}
        self.m_cargo['dll'] = P_dll
        self.m_cargo['this'] = self.m_cargo['dll'].IceRayC_Material_Pigment_Surface_Instruction_Illumination_Beckmann_Isotropic0(
             SizeType( P_result )
            ,SizeType( P_point ) , SizeType( P_normal )
            ,SizeType( P_spotBegin ), SizeType( P_spotEnd )
...
class Beckmann_Anisotropic:
    def __init__( self, P_dll, P_result, P_point, P_normal, P_spotBegin, P_spotEnd, P_specular, P_roughnessX, P_roughnessY ):
        self.m_cargo = {}
        self.m_cargo['dll'] = P_dll
        self.m_cargo['this'] = self.m_cargo['dll'].IceRayC_Material_Pigment_Surface_Instruction_Illumination_Beckmann_Anisotropic0(
             SizeType( P_result )
            ,SizeType( P_point ) , SizeType( P_normal )
            ,SizeType( P_spotBegin ), SizeType( P_spotEnd )
            ,SizeType( P_specular ), SizeType( P_roughnessX ), SizeType( P_roughnessY )
            )
...
class TrowbridgeReitz_Isotropic:
    def __init__( self, P_dll, P_result, P_point, P_normal, P_spotBegin, P_spotEnd, P_specular, P_roughness ):
        self.m_cargo = {}
        self.m_cargo['dll'] = P_dll
        self.m_cargo['this'] = self.m_cargo['dll'].IceRayC_Material_Pigment_Surface_Instruction_Illumination_TrowbridgeReitz_Isotropic0(
             SizeType( P_result )
            ,SizeType( P_point ) , SizeType( P_normal )
            ,SizeType( P_spotBegin ), SizeType( P_spotEnd )
            ,SizeType( P_specular ), SizeType( P_roughness )
...
class TrowbridgeReitz_Anisotropic:
    def __init__( self, P_dll, P_result, P_point, P_normal, P_spotBegin, P_spotEnd, P_specular, P_roughnessX, P_roughnessY ):
        self.m_cargo = {}
        self.m_cargo['dll'] = P_dll
        self.m_cargo['this'] = self.m_cargo['dll'].IceRayC_Material_Pigment_Surface_Instruction_Illumination_TrowbridgeReitz_Anisotropic0(
             SizeType( P_result )
            ,SizeType( P_point ) , SizeType( P_normal )
            ,SizeType( P_spotBegin ), SizeType( P_spotEnd )
            ,SizeType( P_specular ), SizeType( P_roughnessX ), SizeType( P_roughnessY )
...
class Burley_Diffuse: # S( result ), S( point     ), S( normal    ), S( spotBegin ), S( spotEnd ), S( diffuse   ), S( roughness  )
    def __init__(self, P_dll, P_result, P_point, P_normal, P_spotBegin, P_spotEnd, P_diffuse, P_roughness ):
        self.m_cargo = {}
        self.m_cargo['dll'] = P_dll
        self.m_cargo['this'] = self.m_cargo['dll'].IceRayC_Material_Pigment_Surface_Instruction_Illumination_Burley_Diffuse0(
             SizeType( P_result )
            ,SizeType( P_point ) , SizeType( P_normal )
            ,SizeType( P_spotBegin ), SizeType( P_spotEnd )
            ,SizeType( P_diffuse ), SizeType( P_roughness )
            )

    def __del__(self):
        self.m_cargo['dll'].IceRayC_Material_Pigment_Surface_Instruction_Release( self.m_cargo['this'] )

class Burley_Specular: # TODO S( result ), S( point     ), S( normal    ), S( spotBegin ), S( spotEnd ), S( diffuse   ), S( roughness  )
    def __init__(self, P_dll, P_result, P_point, P_normal, P_spotBegin, P_spotEnd, P_specular, P_roughness, P_gamma, P_F0 ):
        self.m_cargo = {}
        self.m_cargo['dll'] = P_dll
        self.m_cargo['this'] = self.m_cargo['dll'].IceRayC_Material_Pigment_Surface_Instruction_Illumination_Burley_Specular0(
             SizeType( P_result )
            ,SizeType( P_point ) , SizeType( P_normal )
            ,SizeType( P_spotBegin ), SizeType( P_spotEnd )
            ,SizeType( P_specular ), SizeType( P_roughness )
            ,SizeType( P_gamma ), SizeType( P_F0 )
            )
...
class CookTorrance:
    def __init__( self, P_dll, P_result, P_point, P_normal, P_spotBegin, P_spotEnd, P_specular, P_roughness, P_IOR ):
        self.m_cargo = {}
        self.m_cargo['dll'] = P_dll
        self.m_cargo['this'] = self.m_cargo['dll'].IceRayC_Material_Pigment_Surface_Instruction_Illumination_CookTorrance0(
             SizeType( P_result )
            ,SizeType( P_point ) , SizeType( P_normal )
            ,SizeType( P_spotBegin ), SizeType( P_spotEnd )
            ,SizeType( P_specular ), SizeType( P_roughness ), SizeType( P_IOR )
            )
